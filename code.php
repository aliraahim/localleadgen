...
$hygieneWords = file('docs/hygiene.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES); //retrieves list of hygiene words
...
$result = ['TotalEmails' => $emailCount, 'LinksSearched' => count($links), 'Emails' => $emails];
