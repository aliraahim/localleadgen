            ...
            <div id="wizard">
                ...
                <div>
                    ...
                    <div style="text-align:center; margin-top:1em; margin-bottom: 5em;">
                        <p>Search radius&nbsp;&nbsp;&nbsp;
                            <input id="radius" data-slider-id='ex1Slider' type="text" data-slider-min="0.1" data-slider-max="5" data-slider-step="0.1" data-slider-value="2" /> <span>&nbsp;&nbsp;&nbsp;</span>
                            <span class="btn-group" data-toggle="buttons">
                                <label class="btn btn-primary active">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Kilometers </label>
                                <label class="btn btn-primary">
                                    <input type="radio" name="options" id="option2" autocomplete="off"> Miles </label>
                            </span>
<!--
                            <select id="units" class="selectpicker" data-width="110px">
